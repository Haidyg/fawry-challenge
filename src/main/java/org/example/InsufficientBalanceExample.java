...
public class InsufficientBalanceExample {
    public static void main(String[] args) {
        ...
        System.out.println("Is expired? " + regularProduct.isExpired());

        System.out.println(expiringProduct);
        System.out.println("Is expired? " + expiringProduct.isExpired());
